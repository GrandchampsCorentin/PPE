...
<form class="mt-2 mb-0" action="index.php?uc=inscription&action=inscription" method="post">
    <div class="form-row">
        <div class="col">
            ...
            value="<?php if(isset($_SESSION['demandeur']))echo $_SESSION['demandeur'][1];else  echo '';?>">
        </div>
        <div class="col">
            ...
            value="<?php if(isset($_SESSION['demandeur']))echo $_SESSION['demandeur'][2];else  echo '';?>">
        </div>
    </div>
    <div class="form-group">
        ...
        value="<?php if(isset($_SESSION['demandeur']))echo $_SESSION['demandeur'][3];else  echo '';?>">
    </div>
    <div class="form-row">
        <div class="col">  
            ...
            value="<?php if(isset($_SESSION['demandeur']))echo $_SESSION['demandeur'][4];else  echo '';?>">
        </div>
        <div class="col">    
            ...
            value="<?php if(isset($_SESSION['demandeur']))echo $_SESSION['demandeur'][5];else  echo '';?>">
        </div>
    </div>
    <div class="form-group">    
        ...
        value="<?php if(isset($_SESSION['demandeur']))echo $_SESSION['demandeur'][0];else  echo '';?>">
    </div>
    <div class="form-group">    
